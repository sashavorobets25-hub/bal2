    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Створено о')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Оновлено о')),
                ('child', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='lab3.child', verbose_name='Куплена дитина')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='child',
            name='orphanage',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lab3.orphanage', verbose_name='Дитячий будинок'),
        ),
    ]
